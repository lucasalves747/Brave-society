...
const en = {
  ...
  apply: {
    ...
    socialLabel: "LinkedIn or Instagram *",
    socialPlaceholder: "linkedin.com/in/yourname",
...
const pt: Dict = {
  ...
  apply: {
    ...
    socialLabel: "LinkedIn ou Instagram *",
    socialPlaceholder: "linkedin.com/in/seunome",
...
const es: Dict = {
  ...
  apply: {
    ...
    socialLabel: "LinkedIn o Instagram *",
    socialPlaceholder: "linkedin.com/in/tunombre",
